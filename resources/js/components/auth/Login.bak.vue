                    ...
                    <form @submit.prevent="login">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                <a href="javascript:void(0)" @click="googleAuthorize">
...
export default {
    ...
    methods: {
       ...
       /*  googleAuthorize() {
            ...
            axios.get('/sanctum/csrf-cookie').then(response => {
                // Login...
                console.log("..secured auth token, attempting google login..")
                this.axios
                    .get('http://localhost:8000/authorize/google', { headers: {
                        "Access-Control-Allow-Origin" : "accounts.google.com"
                    }},)
                    .then(response => (
                        this.$router.push({ name: 'home' })
                        // console.log(response.data)
